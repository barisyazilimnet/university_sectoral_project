							...
							if($query_authorization < 9){
								...
								if($password == $active_query_user["password"]){
									...
									if($query){
										...
										echo message("success","check","Başarılı","$name isimli yetki eklendi");
										_header("admin_authorization");
									}else{
										echo message("warning","exclamation-triangle","Dikkat!","Yetki eklenemedi");
									}
								}else{
									$pass_result=0;
								...
								echo message("warning","exclamation-triangle","Dikkat!","Yetki ekleme sınırını aştınız");
							}
						}
					?>
