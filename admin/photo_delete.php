		...
		<div class="row">
			<div class="col-md-12">
				<?php if(in_array("gallery_transactions", explode(",", $active_query_user["pages"]))){
						...
						if($query_delete){
							system_archives($con, "Fotoğraf silindi", "Fotoğraf Silindi", $active_user_id);
							echo message("success","check","Başarılı","Seçilen fotoğraf başarıyla silinmiştir. Lütfen bekleyiniz");
							_header("gallery_transactions");
						}else{
							echo message("warning","exclamation-triangle","Dikkat!","Seçilen fotoğraf silinememiştir.");
							_header("gallery_transactions");
						}
					}else{
