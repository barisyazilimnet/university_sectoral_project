							...
							if($turkish==False){
								...
								if($photo){
									...
									if($query){
										...
										echo message("success","check","Başarılı","Profiliniz başarılı bir şekilde güncellendi");
										_header("profile");
									}else{
			...
			<div class="col-md-2">
				<div class="card card-info card-outline">
					<div class="card-body box-profile">
						...
						<p class="text-muted text-center"><?php echo _date($active_query_user["birthday"]); ?></p>
                        ...
                        <p class="text-center"><?php echo _date($active_query_user["registration_date"],true); ?></p>
					</div>
					<!-- /.card-body -->
				</div>
				<!-- /.card -->
