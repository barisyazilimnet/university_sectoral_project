				...
				?>
					<div class="card card-info">
						<div class="card-header text-center">
							<h3 class="card-title float-none">Yeni admin üye ekleme</h3>
						</div>
							...
							<div class="card-body">
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control form-control-border border-width-2" name="name" placeholder="Üye adı..." title="Üye adını giriniz" value="<?php if ($_POST) {
																																																echo $name;
																																															} ?>" required>
									</div>
									<div class="form-group col-md-6">
										<label class="mandatory_field">Soyadı</label>
										<input type="text" class="form-control form-control-border border-width-2" name="surname" placeholder="Üye soyadı..." title="Üye soyadını giriniz" value="<?php if ($_POST) {
																																																		echo $surname;
																																																	} ?>" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control form-control-border border-width-2 <?php if ($_POST) {
																														if ($turkish or $user_name_control) {
																															echo 'is-invalid';
																														}
																													} ?>" id="inputError" name="user_name" placeholder="Kullanıcı adı..." title="Kullanıcı adını giriniz" value="<?php if ($_POST) {
																																																																												echo $user_name;
																																																																											} ?>" required>
									...
									<div class="form-group col-md-6">
										...
										<input type="date" class="form-control form-control-border border-width-2" name="birthday" placeholder="Doğum tarihi..." title="Doğum tarihini seçiniz" value="<?php if ($_POST) {
																																																			echo $birthday;
																																																		} ?>" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="tel" class="form-control form-control-border border-width-2" name="phone_number" title="Telefon numarasını giriniz" data-inputmask='"mask": "(999) 999-9999"' data-mask placeholder="Telefon numarası..." value="<?php if ($_POST) {
																																																																				echo $phone_number;
																																																																			} ?>" required>
										</div>
									</div>
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="email" class="form-control form-control-border border-width-2 <?php if ($_POST) {
																															if ($email_control) {
																																echo 'is-invalid';
																															}
																														} ?>" id="inputError" name="email" placeholder="E-mail adresi..." title="E-mail adresini giriniz" value="<?php if ($_POST) {
																																																																								echo $email;
																																																																							} ?>" required>
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="url" class="form-control form-control-border border-width-2" name="web_site" placeholder="Web site adresi..." title="Web site adresini giriniz" value="<?php if ($_POST) {
																																																					echo $web_site;
																																																				} ?>">
										</div>
									</div>
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="url" class="form-control form-control-border border-width-2" name="facebook" placeholder="Facebook adresi..." title="Facebook adresini giriniz" value="<?php if ($_POST) {
																																																					echo $facebook;
																																																				} ?>">
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="url" class="form-control form-control-border border-width-2" name="instagram" placeholder="İnstagram adresi..." title="İnstagram adresini giriniz" value="<?php if ($_POST) {
																																																						echo $instagram;
																																																					} ?>">
										</div>
									</div>
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="url" class="form-control form-control-border border-width-2" name="linkedin" placeholder="Linkedin adresi..." title="Linkedin adresini giriniz" value="<?php if ($_POST) {
																																																					echo $linkedin;
																																																				} ?>">
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="url" class="form-control form-control-border border-width-2" name="pinterest" placeholder="Pinterest adresi..." title="Pinterest adresini giriniz" value="<?php if ($_POST) {
																																																						echo $pinterest;
																																																					} ?>">
										</div>
									</div>
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											...
											<input type="url" class="form-control form-control-border border-width-2" name="twitter" placeholder="Twitter adresi..." title="Twitter adresini giriniz" value="<?php if ($_POST) {
																																																					echo $twitter;
																																																				} ?>">
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<select class="form-control form-control-border border-width-2" name="gender">
											<option value="0" <?php if ($_POST) {
																	if ($gender == 0) {
																		echo "selected";
																	}
																} ?>>Bayan</option>
											<option value="1" <?php if ($_POST) {
																	if ($gender == 1) {
																		echo "selected";
																	}
																} ?>>Bay</option>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<div class="input-group">
											<div class="custom-file"><input type="file" name="photo" class="custom-file-input"><label class="custom-file-label">Dosya seçin...</label></div>
										</div>
									</div>
									<div class="form-group col-md-6">
										...
										<select class="form-control form-control-border border-width-2" name="authorization">
											...
											?>
													<option value="<?php echo $authorization_row["authorization_id"]; ?>" <?php if ($_POST) {
																																if ($authorization == $authorization_row["authorization_id"]) {
																																	echo "selected";
																																}
																															} ?>><?php echo $authorization_row["name"]; ?></option>
											<?php }
											} ?>
										</select>
									</div>
