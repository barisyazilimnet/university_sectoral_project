			...
			<div class="col-md-12">
				<?php if(in_array("gallery_transactions", explode(",", $active_query_user["pages"]))){ ?>
						<div class="card card-info">
							<div class="card-header text-center"><h3 class="card-title float-none">Galeri işlemleri</h3></div>
											...
											while($photos=mysqli_fetch_array($query)){
													...
													<tr>
														...
														<td>
															...
															<a onClick="return del();" href="administrator.php?do=photo_delete&id=<?php echo $photos["id"]; ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i> Sil</button></a>
														</td>
													</tr>
										<?php } ?>
									</tbody>
