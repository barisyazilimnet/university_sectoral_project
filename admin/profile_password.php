...
<div class="content">
	<div class="container-fluid">
		<div class="col-md-12">
			<?php
				if($_POST){
					$new_password = p("new_password","pass");
					$new_password2 = p("new_password2","pass");
					$old_password = p("old_password","pass");
					if($new_password==$new_password2){
						if($active_query_user["password"]==$old_password){
							...
							if($query_update){
								...
								echo message("success","check","Başarılı","Şifreniz başarılı bir şekilde güncellendi");
								_header("profile");
							}else{
							...
							$pass_result=0;
							echo message("warning","exclamation-triangle","Dikkat!","Eski şifrenizi yanlış girdiniz");
						}
					}else{
						$new_pass=0;
						echo message("warning","exclamation-triangle","Dikkat!","Yeni şifreleriniz uyuşmuyor.");
					}
				}
			?>
		</div>
