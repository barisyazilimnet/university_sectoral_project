				...
				<?php if(in_array("admin_user_transactions", explode(",", $active_query_user["pages"]))){
						...
						if($id!=1){
							...
							if($query_delete){
								...
								echo message("success","check","Başarılı","Seçilen üye başarıyla silinmiştir. Lütfen bekleyiniz");
								_header("admin_user_transactions");
							}else{
								echo message("warning","exclamation-triangle","Dikkat!","Seçilen üye silinememiştir.");
								_header("admin_user_transactions");
							}
						}else{
							echo message("danger","ban","Dikkat!","Bu üye silinemez. Lütfen bekleyiniz yönlendirliyorsunuz");
							_header("admin_user_transactions");
						}
					}else{
