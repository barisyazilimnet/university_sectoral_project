						...
						$id=$_GET["id"];
							...
							if($_POST){
								...
								if($password == $active_query_user["password"]){
									...
									if($turkish==False){
										$photo=upload_edit($_FILES["photo"]["tmp_name"],$_FILES["photo"]["name"],$user_name."_photo_","profile_photos/users/",
					...
					<div class="col-md-2">
						<div class="card card-info card-outline">
							<div class="card-body box-profile">
								...
								<p class="text-muted text-center"><?php echo _date($users_query["birthday"]); ?></p>
								...
								<p class="text-center"><?php echo _date($users_query["registration_date"],true); ?></p>
							</div>
							<!-- /.card-body -->
						</div>
						<!-- /.card -->
