								...
								if($user_control){
									...
									if($query_user["status"]){
										$_SESSION["id"] = $query_user["user_id"];
										 echo message("success","check","Başarılı","Kullanıcı giriş başarıyla gerçekleşti. Lütfen bekleyiniz yönlendiriliyorsunuz...");            
										$_SESSION["login_time"] = time();
										_header("");
									}else{
										echo message("warning","warning","Dikkat!","Site yönetici tarafından hesabınız onaylanmamıştır. Lütfen hesabınızın onaylanmasını bekleyiniz.");                                    
									} 
								}else{
									echo message("danger","ban","Başarısız!!!","Kullanıcı adı veya şifreniz hatalı...");                                    
								}
							}else{
