		...
		<div class="login-box w-75">
			<div class="card card-outline card-info">
				<div class="card-header text-center">
					...
					<a href="index.php" class="btn btn-danger float-right">Geri dön</a>
				</div>
				<div class="card-body">
                   ...
                   if($_POST){
								...
								if ($user_name_control == 0){
									...
									if ($email_control == 0){
										...
										if($password==p("password2","pass")){
											...
											if($query){
												echo message("success","check","Başarılı","Sevgili $name_surname kaydınız başarılı bir şekilde oluşturulmuştur. Lütfen sistem yöneticileri tarafından kaydınızı onaylamalarını bekleyiniz");
												header("Refresh:3; url = http://localhost/sp/admin", true, 303);
											}else{
												echo message("warning","warning","Dikkat!","Kaydınız oluşturulamamıştır.");
											}
										}else{
											echo message("warning","warning","Dikkat!","Girdiğiniz şifreler uyuşmuyor.");
										}
									}else{
										echo message("warning","warning","Dikkat!","$email e-posta adresini kullanan başka bir üyemiz mevcut. Lütfen başka bir e-posta ile deneyiniz veya <a href='http://localhost/bp/admin/index.php?giris=$email'><button type='submit' class='btn btn-info'>Giriş yap</button></a> butona tıklayarak giriş yapınız.");
									}
								}else{
									echo message("warning","warning","Dikkat!","$user_name kullanıcı adını kullanan başka bir üyemiz mevcut. Lütfen başka bir kullanıcı adı ile deneyiniz veya <a href='http://localhost/bp/admin/index.php?giris=$user_name'><button type='submit' class='btn btn-info'>Giriş yap</button></a> butona tıklayarak giriş yapınız.");
								}
                            }else{
								echo message("warning","warning","Dikkat!","Lütfen kullanıcı adında türkçe karakterler ( ğ, Ğ, ç, Ç, ş, Ş, ü, Ü, ö, Ö, ı, İ ) kullanmayınız");
                            }
                        }else{
							echo message("danger","ban","Başarısız!","Lütfen güvenligi dogrulayınız.");
                        }
                    }
					?>
					<form method="post" action="<?php $_SERVER["PHP_SELF"]; ?>">
						...
						<div class="row mb-2">
							<div class="form-group col-6">
								<label class="mandatory_field mb-0">Kullanıcı adınız</label>
						...
						<div class="row mb-3">
							...
							<div class="form-group col-6">
								...
								<div class="input-group">
									<div class="input-group-append">
										<div class="input-group-text" style="border:none !important; background-color: transparent !important;">
						...
						<div class="row mb-2">
							<div class="form-group col-6">
								...
								<small class="text-muted "> Şifrenizde büyük ve küçük harf, rakam, özel karakter bulunmalıdır ve 8 karakterli olmalıdır.</small>
							</div>
							<div class="form-group col-6">
						...
						<div class="row float-right"><button type="submit" class="btn btn-outline-info">Kayıt ol</button></div>
					</form>
				</div>
				<!-- /.card-body -->
			</div>
